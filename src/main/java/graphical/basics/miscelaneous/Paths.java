...
public class Paths extends Animation {
    @Override
    ...
    public void buildAnimation() {
        ...
        new PositionListTransform(sg2.getReferenceLocations(),sg.getReferenceLocations(),seconds(1)).execute();
