...
public class CircleEx extends Animation {
    @Override
    ...
    public void buildAnimation() {
      ...
      //  getBackGround().getColors().get(0).setColor(new Color(0,0,0,80));
        ...
        Animations.t3b1b(b2,cog2,seconds(1))
                .parallel(Animations.t3b1b(b1,cog,seconds(1)))
                .execute();
...
//        Positioning.align(camera,cog3, Positioning.Reference.CENTER);
        ...
        var cir= CircleBuilder.aCircle().build();
        add(group);
