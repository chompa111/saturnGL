...
public class Browser2{
     ...
     */
    public Browser2(String startURL, boolean useOSR, boolean isTransparent, String[] args) throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
        ...
        panel.add(address_, BorderLayout.NORTH);
...
//        });
    ...
    public static void main(String[] args) throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
        ...
        new Browser2("http://www.google.com", useOsr, false, args);
    }
}