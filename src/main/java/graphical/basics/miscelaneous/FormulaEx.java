...
public class FormulaEx extends Animation {
    @Override
    ...
    public void buildAnimation() {
       ...
       // add(plainFormula2);
        ...
        add(plainFormula);
        Animations.strokeAndFill(plainFormula,seconds(1)).execute();
        ...
        Animations.emphasize(yminusz).execute();
        add(plainFormula2);
        remove(yminusz);
        remove(plainFormula);
